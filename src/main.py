...
if __name__ == "__main__":
    ...
    parser.add_argument('--experiment', type=str, default='legion', choices=['legion', 'aero', 'finance', 'all'],
    ...
    parser.add_argument('--save_path', type=str, default='outputs/legion_brain_final.pth', help='Path to save/load the Legion model.')
